...
(define (create-mit)
  (let ((great-dome (create-place 'great-dome))
        ...
        (medical-center (create-medical-center 'medical-center 4)))
    ...
    (can-go-both-ways infinite 'east 'west medical-center)
    ...
    (can-go-both-ways medical-center 'west 'north bldg-54)
    (can-go-both-ways medical-center 'south 'down 32G)

    ; Add line-of-sight into the mix
    (can-see bldg-54 32G)
    (can-see bldg-54 32D)
    (can-see medical-center bldg-54)
    ...
    (create-invisibility-cloak 'invisibility-cloak great-dome)
...
(define (create-invisibility-cloak name location)
  (make-invisibility-cloak 'name name
                           'location location
                           'harm 2))

(define (create-sword name location)
  (make-sword 'name name
              'location location
              'damage-inflicted 10))
...
(define (create-medical-center name recovery-rate)
  (make-medical-center 'name name
